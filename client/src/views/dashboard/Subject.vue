<template>
    <div class="w-full h-full flex relative bg-pattern bg-fixed bg-cover" ref="mainRef">
        ...
        <div class="font-extrabold text-tosca bg-gradient-to-r from-shade-gr to-transparent rounded-xl flex px-2 text-[1.5rem] mb-6 w-full">DAFTAR MATA PELAJARAN</div>
