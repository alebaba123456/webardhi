<template>
    <div class="w-full h-full flex relative bg-pattern bg-fixed bg-repeat" ref="mainRef">
        ...
        <div class="font-extrabold text-tosca bg-gradient-to-r from-gr via-shade-gr to-transparent rounded-xl flex px-2 text-[1.5rem] mb-6 w-full" ref="filter">JADWAL UJIAN SAYA</div>
...
import TableExamination from '@/components/tables/table-examination-student.vue';
